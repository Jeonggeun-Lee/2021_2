...
message(STATUS "turtlesim_cleaner: 0 messages, 1 services")
...
get_filename_component(_filename "/home/dron/catkin_ws/src/turtlesim_cleaner/srv/AngleDistance.srv" NAME_WE)
add_custom_target(_turtlesim_cleaner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "turtlesim_cleaner" "/home/dron/catkin_ws/src/turtlesim_cleaner/srv/AngleDistance.srv" ""
)
...
_generate_srv_cpp(turtlesim_cleaner
  "/home/dron/catkin_ws/src/turtlesim_cleaner/srv/AngleDistance.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/turtlesim_cleaner)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/turtlesim_cleaner\")")
  # install generated code
  install(
