...
get_filename_component(_filename "/home/dron/catkin_ws/src/my_pkg/srv/AddTwoInts.srv" NAME_WE)
add_custom_target(_my_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_pkg" "/home/dron/catkin_ws/src/my_pkg/srv/AddTwoInts.srv" ""
)
...
_generate_srv_cpp(my_pkg
  "/home/dron/catkin_ws/src/my_pkg/srv/AddTwoInts.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_pkg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_pkg\")")
  # install generated code
  install(
